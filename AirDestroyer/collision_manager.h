...
{
public:
    static bool DoCollisions(GameObject* aGameObject, GameObject* bGameObject, bool aPixelPerfectCollision = true, bool bPixelPerfectCollision = true);
    static bool CheckMask(GameObject* aGameObject, int xOffset, int yOffset);
